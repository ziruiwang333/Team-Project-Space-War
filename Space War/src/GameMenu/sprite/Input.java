...
public class Input {
	...
	private KeyCode upKey2 = KeyCode.W;
	private KeyCode downKey2 = KeyCode.S;
	private KeyCode leftKey2 = KeyCode.A;
	private KeyCode rightKey2 = KeyCode.D;
	private KeyCode primaryWeaponKey2 = KeyCode.P;
//    private KeyCode secondaryWeaponKey2 = KeyCode.CONTROL;
//    private KeyCode escape2 = KeyCode.ESCAPE;
	...
	public boolean isMoveUp2() {
		return keyboardBitSet.get(upKey2.ordinal()) && !keyboardBitSet.get(downKey2.ordinal());
	}

	public boolean isMoveDown2() {
		return keyboardBitSet.get(downKey2.ordinal()) && !keyboardBitSet.get(upKey2.ordinal());
	}

	public boolean isMoveLeft2() {
		return keyboardBitSet.get(leftKey2.ordinal()) && !keyboardBitSet.get(rightKey2.ordinal());
	}

	public boolean isMoveRight2() {
		return keyboardBitSet.get(rightKey2.ordinal()) && !keyboardBitSet.get(leftKey2.ordinal());
	}

	public boolean isPlayer2FirePrimaryWeapon() {
		return keyboardBitSet.get(primaryWeaponKey2.ordinal());
	}
}